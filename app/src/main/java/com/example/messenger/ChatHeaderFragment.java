...
public class ChatHeaderFragment extends Fragment {
    ...
    public static ChatHeaderFragment newInstance(String param1, String param2) {
        ChatHeaderFragment fragment = new ChatHeaderFragment();
    ...
    public ChatHeaderFragment(int chatLogoId, String chatNameText) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        chatLogo = view.findViewById(R.id.chat_header_logo_iv);
        chatName = view.findViewById(R.id.chat_header_name_tv);
